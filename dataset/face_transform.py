...
write_path_prefix = "/mnt/data/zhangqingyang/Aff-Wild2/imgs/"
box_enlarge = 2.1
img_size = 112

all_imgs_path = open(list_path_prefix + 'train_path.txt').readlines()
all_imgs_land = np.loadtxt(list_path_prefix  + 'train_landmark.txt')
...
np.savetxt(list_path_prefix+'new_land.txt', all_imgs_new_land, fmt='%f', delimiter='\t')